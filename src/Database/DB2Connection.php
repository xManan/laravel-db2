...
namespace NFT\DB2\Database;

use PDO;

use Illuminate\Database\Connection;

use NFT\DB2\Database\Schema\Builder;
use NFT\DB2\Database\Query\Processors\DB2Processor;
use NFT\DB2\Database\Query\Processors\DB2ZOSProcessor;
use NFT\DB2\Database\Query\Grammars\DB2Grammar as QueryGrammar;
use NFT\DB2\Database\Schema\Grammars\DB2Grammar as SchemaGrammar;
use NFT\DB2\Database\Schema\Grammars\DB2ExpressCGrammar;
...
class DB2Connection extends Connection
{
     ...
     *
     * @return \NFT\DB2\Database\Schema\Builder
     */
     ...
     *
     * @return \NFT\DB2\Database\Query\Processors\DB2Processor|\NFT\DB2\Database\Query\Processors\DB2ZOSProcessor
     */
